                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="nick" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="phone" required="" type="tel">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="password" required="" type="tel">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="control-group">
                                    <div class="radio"><label><input checked="checked" class="colored-blue" name="form-field-radio" type="radio" value="1"><span class="text">1 </span></label></div>
                                    <div class="radio"><label><input class="colored-danger" name="form-field-radio" type="radio" value="2"><span class="text"> 2</span></label></div>
                                    <div class="radio"><label><input class="colored-success" name="form-field-radio" type="radio" value="3"><span class="text"> 3</span></label></div>
                                    <div class="radio"><label><input class="colored-blueberry" name="form-field-radio" type="radio" value="4"><span class="text"> 4</span></label></div>
                                </div>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
