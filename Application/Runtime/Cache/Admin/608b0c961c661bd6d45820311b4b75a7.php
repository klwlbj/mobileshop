...
<div class="row">
                                ...
                                <div class="tab-pane active" id="home11">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select name="cate_id">
                                                ...
                                                <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($vo['level']!=2)echo'disabled="disabled"'?> <?php if($vo['id'] == $goods['cate_id']): ?>selected<?php endif; ?> value="<?php echo ($vo["id"]); ?>"><?php if($vo['pid'] != 0): ?>|<?php endif; echo str_repeat('-', $vo['level']*8); echo ($vo["catename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                        <p class="help-block col-sm-4 red">* 必填</p>
                                    </div>
                                    <!--<div class="form-group">-->
                                        ...
                                        <!--<div class="col-sm-6">-->
                                            ...
                                            <!--<?php if(is_array($brandres)): $i = 0; $__LIST__ = $brandres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>-->
                                                <!--<option <?php if($vo['id'] == $goods['brand_id']): ?>selected<?php endif; ?> value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["brand_name"]); ?></option>-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" required="" name="vip2_price" value="<?php echo ($goods["vip2_price"]); ?>" placeholder="" class="form-control" >
                                        </div>
                                        <p class="help-block col-sm-4 red">* 必填</p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" required="" name="vip3_price" value="<?php echo ($goods["vip3_price"]); ?>" placeholder="" class="form-control" >
                                        </div>
                                        <p class="help-block col-sm-4 red">* 必填</p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" required="" name="vip4_price" value="<?php echo ($goods["vip4_price"]); ?>" placeholder="" class="form-control" >
                                        </div>
                                        <p class="help-block col-sm-4 red">* 必填</p>
                                    </div>
                                    <div class="form-group">
    ...
    function attrad(o){
        ...
        if($(o).html() == '[+]'){
            ...
            if(confirm('确定要删除该商品属性吗？')){
                ...
                $.ajax({
                type:"GET",
                url:"/index.php/Admin/Goods/ajaxdelga/gaid/"+gaid,
    ...
    function delpic(o){
        if(confirm('确定要删除该图片吗？')){
            ...
            $.ajax({
                type:"GET",
                url:"/index.php/Admin/Goods/ajaxdelpic/picid/"+picid,
                success:function(data){
                    li.remove();
                }
            });
