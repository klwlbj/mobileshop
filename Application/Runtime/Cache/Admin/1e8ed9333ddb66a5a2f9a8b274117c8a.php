                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="/index.php/Admin/Index/index">系统</a>
                                        ...
                                        <li>
                        <a href="/index.php/Admin/MemberLevel/lst">会员列表</a>
                    </li>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="nick" required="" value="<?php echo ($user["nick"]); ?>" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">会员手机</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="phone" required="" value="<?php echo ($user["phone"]); ?>" type="tel">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="password" required="" value="<?php echo ($user["password"]); ?>" type="tel">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">会员等级</label>
                            <div class="col-sm-6">

                                <div class="control-group">
                                    <div class="radio"><label><input <?php if($user["vip"] == 1): ?>checked="checked"<?php endif; ?> class="colored-blue" name="form-field-radio" type="radio" value="1"><span class="text">1 </span></label></div>
                                    <div class="radio"><label><input <?php if($user["vip"] == 2): ?>checked="checked"<?php endif; ?> class="colored-danger" name="form-field-radio" type="radio" value="2"><span class="text"> 2</span></label></div>
                                    <div class="radio"><label><input <?php if($user["vip"] == 3): ?>checked="checked"<?php endif; ?> class="colored-success" name="form-field-radio" type="radio" value="3"><span class="text"> 3</span></label></div>
                                    <div class="radio"><label><input <?php if($user["vip"] == 4): ?>checked="checked"<?php endif; ?> class="colored-blueberry" name="form-field-radio" type="radio" value="4"><span class="text"> 4</span></label></div>
                                </div>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
