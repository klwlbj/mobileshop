...
<html><head>
    ...
    <!-- 引入ueditor -->
    <script src="http://x.goodydx.com/Application/Admin/Public/ueditor/ueditor.config.js"></script>
    <script src="http://x.goodydx.com/Application/Admin/Public/ueditor/ueditor.all.min.js"></script>
    <script src="http://x.goodydx.com/Application/Admin/Public/ueditor/lang/zh-cn/zh-cn.js"></script>
</head>
<body>
    <!-- 头部 -->
    <div class="navbar">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="/index.php/Admin/Index/index">系统</a>
                                        ...
                                        <li>
                        <a href="/index.php/Admin/Article/lst">文章列表</a>
                    </li>
