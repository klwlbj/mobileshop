                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" width="10%">访问总次数</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if(is_array($ip)): $i = 0; $__LIST__ = $ip;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    <td align="center"><?php echo ($vo["id"]); ?></td>
                                    <td align="left"><?php echo ($vo["ip"]); ?></td>
                                    <td align="left"><?php echo ($vo["area"]); ?></td>
                                    <td align="left"><?php echo (date("Y-m-d H:i:s",$vo["time"])); ?></td>
                                    <td align="left"> <?php if($vo["btime"] != ''): echo (date("Y-m-d H:i:s",$vo["btime"])); endif; ?> </td>
                                    <td align="left"><?php echo ($vo["count"]); ?></td>
