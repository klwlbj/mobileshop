...
<!-- saved from url=(0046)http://m.360kad.com/zhuanti/app_kad_zcxy.shtml -->
<html lang="UTF-8" style="font-size: 210.933px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script type="text/javascript" async="" charset="utf-8" src="/Public/zcxy_files/ga.js"></script><script language="javascript" type="text/javascript" src="/Public/zcxy_files/envconfig.js"></script>
<script language="javascript" type="text/javascript" async="async" src="/Public/zcxy_files/ctr_v2.js"></script>
<!--布局:app_kad_zcxy-->
<title>注册协议</title>
...
<script src="/Public/zcxy_files/jquery-1.10.1.min.js" type="text/javascript"></script>
<script src="/Public/zcxy_files/iOS-JS-Drivers-2.0.4.js" type="text/javascript"></script>
<script src="/Public/zcxy_files/other.js" type="text/javascript">
</script>
<link href="/Public/zcxy_files/common.css" rel="stylesheet" type="text/css">

<style type="text/css">
.show{font-family: "黑体";color: #444;width:94%;line-height:.5rem;padding: 0 3% 3% 3%;}
.warp-box h4{text-align:center;font-size:.4rem;padding:0;line-height:1rem;/*background:#fff;border-top:1px solid #CCC;border-bottom:1px solid #CCC;*/}
.show p{text-indent:2em;font-size:.3rem; }
.show h2{font-size:.3rem;font-weight:bold;}
</style>
<script type="text/javascript" src="/Public/zcxy_files/ga(1).js" charset="utf-8" id="r_script"></script></head>
<body>
<section class="warp-box">
<h4>驼铃商贸注册协议</h4>
<div class="show">
<p>欢迎您注册成为驼铃商贸的会员！请仔细阅读下面的协议，您需阅读并同意本协议的情况下，才能继续进行会员注册。</p>
<h2>一、本站服务条款的确认和接纳</h2>
<p>本站的各项电子服务的所有权和运作权归本站。本站提供的服务将完全按照其发布的服务条款和操作规则严格执行。用户必须完全同意所有服务条款并完成注册程序，才能成为本站的正式用户。用户确认：本协议条款是处理双方权利义务的当然约定依据，除非违反国家强制性法律，否则始终有效。在提交订单的同时，您也同时承认了您拥有购买这些产品的权利能力和行为能力，并且将您对您在订单中提供的所有信息的真实性负责。</p>
<h2>二、服务简介</h2>
<p>本站运用自己的操作系统通过国际互联网络为用户提供网络服务。同时，用户必须：</p>
<p>1、自行配备上网的所需设备，包括个人电脑、调制解调器或其它必备上网装置。</p>
<p>2、自行负担个人上网所支付的与此服务有关的电话费用、网络费用。 基于本站所提供的网络服务的重要性，用户应同意：</p>
<p>（1）提供详尽、准确的个人资料。</p>
<p>（2）不断更新注册资料，符合及时、详尽、准确的要求。</p>
<p>本站不公开用户的姓名、地址、电子邮箱和笔名，除以下情况外：</p>
<p>（1）用户授权本站透露这些信息。</p>
<p>（2）相应的法律及程序要求本站提供用户的个人资料。</p>
<p>如果用户提供的资料包含有不正确的信息，本站保留终止用户使用网络服务资格的权利。</p>
<h2>三、价格和数量</h2>
<p>本站将尽最大努力保证您所购商品与网站上公布的价格一致，但价目表和声明并不构成要约。本站有权在发现了其网站上显现的产品及订单的明显错误或缺货的情况下，单方面撤回任何承诺。同时，本站保留对产品订购的数量的限制权。</p>
<p>产品的价格和可获性都在本站上指明。这类信息将随时更改且不发任何通知。商品的价格都包含了增值税。如果发生了意外情况，在确认了您的订单后，由于供应商提价，税额变化引起的价格变化，或是由于网站的错误等造成商品价格变化，您有权取消您的订单，并希望您能及时通过电子邮件或电话通知本站客服部。 您所订购的商品，如果发生缺货，您有权取消订单。</p>
<h2>四、送货及费用</h2>
<p>本站将会把产品送到您所指定的送货地址。所有在本站上列出的送货时间为参考时间，参考时间的计算是根据库存状况、正常的处理过程和送货时间、送货地点的基础上估计得出的。送货费用根据您选择的配送方式的不同而异。
请工整、准确地填写您的真实姓名、送货地址及联系方式。因如下情况造成订单延迟或无法配送等，本站将不承担责任：</p>
...
<h2>六、用户隐私制度</h2>
<p>尊重用户个人隐私是本站的一项基本政策。所以，作为对个人注册资料的补充，本站一定不会在未经合法用户授权时公开、编辑或透露其注册资料及保存在本站中的非公开内容，除非有法律许可要求或本站在诚信的基础上认为透露这些信件在以下四种情况是必要的：</p>
...
<p>（1）停止使用本站的网络服务。</p>
<p>（2）通告本站停止对该用户的服务。</p>
<p>结束用户服务后，用户使用网络服务的权利马上中止。从那时起，用户有权利，本站也没有义务传送任何未处理的信息或未完成的服务给其他用户或第三方。</p>
<h2>十四、通告</h2>
...
<script type="text/javascript" src="/Public/zcxy_files/rt.js"></script>
<noscript>
&lt;div style="display:none;"&gt;
&lt;img height="0" width="0" style="border-style:none;" src="//eclick.baidu.com/rt.jpg?t=noscript&amp;rtid=nHRvPjm" /&gt;
&lt;/div&gt;
</noscript>
</div>
<script type="text/javascript">var _kc_userID="199209";</script>
<!--部件结束:m_themecommon_GA-->
