...
<body>
    ...
    <section class="m-registration-wrap">
        ...
        <div class="reg-input-wrap relative display-box">
            ...
            <p class="reg-right pass-word box-flex1 input"><input  name="password" id="password" value="" maxlength="20" placeholder="请设置6位数以上密码"></p>
    ...
    <script type="text/javascript">
        ...
        function ifShow() {
            ...
            if (an == 'end' && phone.length >= 11 && password.length >= 6 && nick.length  >= 6) {
