    ...
    <form class="form-inline" method="post" action="">
        <div id="distpicker4">
            <div class="form-group">
                ...
                省：<select class="form-control" id="province9" name="province" required="required"></select>
            </div>
            <div class="form-group">
                <label class="sr-only" for="city9">City</label>
                市：<select class="form-control" id="city9" name="city" required="required"></select>
            </div>
            <div class="form-group">
                <label class="sr-only" for="district9">District</label>
                区：<select class="form-control" id="district9" name="district" required="required"></select>
            </div>
            <div class="form-group">
                <label class="sr-only" for="district9">详细地址</label>
                详细地址：<textarea type="text" class="form-control"  name="address" required="required"></textarea>
            </div>
            <div class="form-group">
                <label class="sr-only" for="district9">联系人</label>
                联系人：<input type="text" class="form-control"  name="username" required="required"></input>
            </div>
            <div class="form-group">
